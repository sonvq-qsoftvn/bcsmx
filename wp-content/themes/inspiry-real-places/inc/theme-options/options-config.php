<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Theme Options', 'inspiry' ),
        'page_title'           => __( 'Theme Options', 'inspiry' ),
    ...
    /*$args['admin_bar_links'][] = array(
        ...
        'title' => __( 'Documentation', 'inspiry' ),
    );

    $args['admin_bar_links'][] = array(
        //'id'    => 'redux-support',
        'href'  => 'https://github.com/ReduxFramework/redux-framework/issues',
        'title' => __( 'Support', 'inspiry' ),
    );

    $args['admin_bar_links'][] = array(
        'id'    => 'redux-extensions',
        'href'  => 'reduxframework.com/extensions',
        'title' => __( 'Extensions', 'inspiry' ),
    );*/
    ...
    /*if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        $args['intro_text'] = sprintf( __( '<p>Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: <strong>$%1$s</strong></p>', 'inspiry' ), $v );
    } else {
        $args['intro_text'] = __( '<p>This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.</p>', 'inspiry' );
    }*/

    // Add content after the form.
    // $args['footer_text'] = __( '<p>This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.</p>', 'inspiry' );
...
/*$tabs = array(
    array(
        'id'      => 'redux-help-tab-1',
        'title'   => __( 'Theme Information 1', 'inspiry' ),
        'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'inspiry' )
    ),
    array(
        'id'      => 'redux-help-tab-2',
        'title'   => __( 'Theme Information 2', 'inspiry' ),
        'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'inspiry' )
    )
);
...
/* $content = __( '<p>This is the sidebar content, HTML is allowed.</p>', 'inspiry' );
